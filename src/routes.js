...
const Edit = React.lazy(() => import('./views/theme/edit/Edit'));
const Perki = React.lazy(() => import('./views/theme/perki/Perki'));
const Perki2 = React.lazy(() => import('./views/theme/perki2/Perki2'));
const Info = React.lazy(() => import('./views/theme/info/Info'));
const Jadwal = React.lazy(() => import('./views/theme/jadwal/Jadwal'));
const Sponsor = React.lazy(() => import('./views/theme/sponsor/Typography'));
...
const routes = [
  ...
  { path: '/theme/edit/:id', name: 'Edit', component: Edit },
  { path: '/theme/perki', name: 'Perki', component: Perki },
  { path: '/theme/perki2/:id', name: 'Perki2', component: Perki2 },
  { path: '/theme/sponsor', name: 'Sponsor', component: Sponsor },
