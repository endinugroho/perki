...
//  });
 ...
 axios({
  ...
  data: {"email":user.email,"mtd":'FORGOTPASSWORD'},
  contentType: "application/json",
})
  .then((data) => {
        ...
        <CRow className="justify-content-center">
          ...
          <img src="https://acsasurabaya2021.com/wp-content/uploads/2019/05/Logo-atas.png" width="200" />
            <CCard className="mx-4" >
              ...
              <img src="https://acsasurabaya2021.com/wp-content/plugins/perki/register.png" width="150" style={{float:"right"}} />
                <CForm>
                  {/* {JSON.stringify(user)} */}
                  ...
                  <CButton color="success" block onClick={()=>simpan()}>Submit</CButton>
                </CForm>
              </CCardBody>
            </CCard>
          </CCol>
